...
export default function Home() {
  ...
  return <main>
    ...
    <section className="hero" id="top">
      ...
      <header className="site-header shell"><a className="monogram" href="#top" aria-label="Arush Kukreja, home">AK<span>.</span></a><nav className="nav" aria-label="Primary navigation"><a href="#work">Experience</a><a href="#ai-lab">AI systems</a><a href="#projects">Products</a><a href="#signals">Writing</a></nav><Button asChild variant="outline" size="sm" className="header-button"><a href="/book">Book a call <ArrowUpRight aria-hidden="true" /></a></Button></header>
    ...
    <footer className="footer"><div className="shell"><Badge variant="outline">Start a conversation</Badge><h2>Have a hard problem where risk, data, product, and AI meet?</h2><Button asChild size="lg" className="footer-action"><a href="/book">Book a call <ArrowUpRight aria-hidden="true" /></a></Button><div className="footer-bottom"><span>Arush Kukreja © 2026</span><div><a href="https://www.linkedin.com/in/arushkukreja" target="_blank" rel="noreferrer">LinkedIn</a><a href="/Arush-Kukreja-Resume.pdf" download>Résumé</a><a href="#top">Back to top ↑</a></div></div></div></footer>
  </main>;
}
