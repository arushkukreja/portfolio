...
export default function Home() {
  ...
  return <main>
    ...
    <footer className="footer" id="connect"><div className="shell"><Badge variant="outline">Start a conversation</Badge><h2>Have a hard problem where risk, data, product, and AI meet?</h2><p className="contact-intro">Choose the way that works for you.</p><div className="contact-actions"><Button asChild size="lg" className="footer-action"><a href="/book">Book a call <ArrowUpRight aria-hidden="true" /></a></Button><Button asChild size="lg" variant="outline" className="footer-action contact-alternative"><EmailLink>Send an email <ArrowUpRight aria-hidden="true" /></EmailLink></Button><Button asChild size="lg" variant="outline" className="footer-action contact-alternative"><a href="https://www.linkedin.com/in/arushkukreja" target="_blank" rel="noreferrer">Connect on LinkedIn <ArrowUpRight aria-hidden="true" /></a></Button></div><div className="footer-bottom"><span>Arush Kukreja © 2026</span><div><a href="https://www.linkedin.com/in/arushkukreja" target="_blank" rel="noreferrer">LinkedIn</a><a href="/Arush-Kukreja-Resume.pdf" download>Résumé</a><a href="#top">Back to top ↑</a><LegalLinks /></div></div></div></footer>
  </main>;
}
